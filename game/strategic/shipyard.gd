...
##
## "One shipyard per realm": each side's home hub system (Galaxy's A1/C1)
...
const SHIPYARDS := {"A1": 0, "C1": 1}        # system id -> the side whose realm it belongs to


## Passive materiel income for both sides, scaled by how many systems each
## currently owns — more territory means more industry, same as GDD §4.2.
